...
RSpec.describe Forecast, type: :model do
  context "validations" do
     ...
     it {should validate_presence_of(:current_wind_speed)}
     ...
     it {should validate_presence_of(:period_one_day_wind_speed)}
     ...
     it {should validate_presence_of(:period_one_night_wind_speed)}
     ...
     it {should validate_presence_of(:period_two_day_wind_speed)}
     ...
     it {should validate_presence_of(:period_two_night_wind_speed)}
     ...
     it {should validate_presence_of(:period_three_day_wind_speed)}
     ...
     it {should validate_presence_of(:period_three_night_wind_speed)}
     ...
     it {should validate_presence_of(:period_four_day_wind_speed)}
     ...
     it {should validate_presence_of(:period_four_night_wind_speed)}
     ...
     it {should validate_presence_of(:period_five_day_wind_speed)}
     ...
     it {should validate_presence_of(:period_five_night_wind_speed)}
